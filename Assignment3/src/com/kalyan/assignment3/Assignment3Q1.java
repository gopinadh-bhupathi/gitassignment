...
public class Assignment3Q1 {
	public static void main(String[] args) {
    	...
    	person.add(new Person("Gopinadh",165,65));
    	person.add(new Person("Kalyan",170,75));
    	person.add(new Person("Pavan",158,65));
    	person.add(new Person("Vignesh",165,60));
    	person.add(new Person("vivek",162,68));
